...
class Darcy1DSolver:
    ...
    def permeability(self, s):
        """Stronger nonlinear permeability function k(s) = k0 + alpha * s^2"""
        k0 = 0.05
        alpha = 5.0
        return k0 + alpha * s**2
...
if __name__ == "__main__":
    ...
    dataset_path = os.path.join(save_dir, "darcy_1d_dataset_501_sigma_0.01")
    ...
    plt.tight_layout()
    plot_path = os.path.join(save_dir, 'darcy_sample_501_n.png')
